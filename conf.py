...
BLOG_AUTHOR = "Lorenzo Rovigatti"  # (translatable)
BLOG_TITLE = "Lorenzo Rovigatti"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.roma1.infn.it/~rovigatl/"
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -rav --delete --delete-after output/ rovigatl@login.roma1.infn.it:www/",
    ]
}
...
# Nikola’s templates. All othWrite your page here.er filters must be enabled through FILTERS.
#
...
# If False, index-1.html has Write your page here.the second-newest posts, index-2.html the third-newest,
...
GLOBAL_CONTEXT = {
    'email' : 'lorenzo.rovigatti@uniroma1.it',
    'twitter' : 'lrovigatti',
    'github' : 'lorenzo-rovigatti'
}
